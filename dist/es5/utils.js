...
var Utils = /** @class */ (function () {
    ...
    Utils.updateStyleOnElements = function (selector, styles) {
        var elements = typeof selector === 'string' ? Utils.getElements(selector) : selector;
    ...
    Utils.addElementStyle = function (el, styles) {
        if (!el) {
            return;
        }
        if (styles) {
    ...
    Utils.updatePositionStyleOnWidget = function (el, cellHeight, cellHeightUnit) {
        var h = Utils.toNumber(el.getAttribute('gs-h'));
        var minH = Utils.toNumber(el.getAttribute('gs-min-h'));
        var maxH = Utils.toNumber(el.getAttribute('gs-max-h'));
        var y = Utils.toNumber(el.getAttribute('gs-y'));
    ...
    Utils.getCSSHeight = function (rows, cellHeight, cellHeightUnit) {
        return rows * cellHeight + cellHeightUnit;
    };

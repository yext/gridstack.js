...
var GridStack = /** @class */ (function () {
    ...
    GridStack.prototype.addWidget = function (els, options) {
        ...
        utils_1.Utils.updatePositionStyleOnWidget(el, this.opts.cellHeight, this.opts.cellHeightUnit);
        return el;
    };
    /**
    /**
    ...
    GridStack.prototype._updateStyles = function (forceUpdate, maxH) {
        ...
        if (!this._maxRowIndex) {
            ...
            utils_1.Utils.updateStyleOnElements(prefix, { 'min-height': cellHeight + cellHeightUnit });
            this._updateElementChildrenStyling(undefined, prefix);
        }
        // apply position styling on all dirty node's elements
        this.getGridItems().forEach(function (w) {
            if (w.gridstackNode._dirty) {
                utils_1.Utils.updatePositionStyleOnWidget(w, _this.opts.cellHeight, _this.opts.cellHeightUnit);
            }
        });
    ...
    GridStack.prototype._updateElementChildrenStyling = function (el, prefix) {
        ...
        if (el !== undefined) {
            ...
            // content margins
            utils_1.Utils.updateStyleOnElements([el.querySelector(content)], { top: top, right: right, bottom: bottom, left: left });
            utils_1.Utils.updateStyleOnElements(placeholder, { top: top, right: right, bottom: bottom, left: left });
            // resize handles offset (to match margin)
            utils_1.Utils.updateStyleOnElements([el.querySelector(".ui-resizable-ne")], { right: right });
            utils_1.Utils.updateStyleOnElements([el.querySelector(".ui-resizable-e")], { right: right });
            utils_1.Utils.updateStyleOnElements([el.querySelector(".ui-resizable-se")], { right: right, bottom: bottom });
            utils_1.Utils.updateStyleOnElements([el.querySelector(".ui-resizable-nw")], { left: left });
            utils_1.Utils.updateStyleOnElements([el.querySelector(".ui-resizable-w")], { left: left });
            utils_1.Utils.updateStyleOnElements([el.querySelector(".ui-resizable-sw")], { left: left, bottom: bottom });
        }
        if (prefix != undefined) {
            content = prefix + " > .grid-stack-item-content";
            // content margins
            utils_1.Utils.updateStyleOnElements(content, { top: top, right: right, bottom: bottom, left: left });
            utils_1.Utils.updateStyleOnElements(placeholder, { top: top, right: right, bottom: bottom, left: left });
            // resize handles offset (to match margin)
            utils_1.Utils.updateStyleOnElements(prefix + " > .ui-resizable-ne", { right: right });
            utils_1.Utils.updateStyleOnElements(prefix + " > .ui-resizable-e", { right: right });
            utils_1.Utils.updateStyleOnElements(prefix + " > .ui-resizable-se", { right: right, bottom: bottom });
            utils_1.Utils.updateStyleOnElements(prefix + " > .ui-resizable-nw", { left: left });
            utils_1.Utils.updateStyleOnElements(prefix + " > .ui-resizable-w", { left: left });
            utils_1.Utils.updateStyleOnElements(prefix + " > .ui-resizable-sw", { left: left, bottom: bottom });
        }
    };
    /** @internal */

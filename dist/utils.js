...
class Utils {
    ...
    static updateStyleOnElements(selector, styles) {
    ...
    static addElementStyle(el, styles) {
        if (!el) {
            return;
        }
        if (styles) {
    ...
    static updatePositionStyleOnWidget(el, cellHeight, cellHeightUnit) {
    ...
    static getCSSHeight(rows, cellHeight, cellHeightUnit) {
